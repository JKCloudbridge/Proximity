...
/// SPRINT_PLANNING.md §7.1/§11 Sprint 5: the PDP -- images, variant
/// selection, price/stock. §11's exit criteria for this sprint is the full
/// chain "Home -> shop -> product -> variant," which ends here; "Add to
/// cart" is a real, visible button but intentionally inert (Sprint 6 owns
/// `cart_items`, which doesn't exist yet) -- same "wired now, built later"
            ...
            child: Padding(
              ...
              child: FilledButton(
                onPressed: selectedVariant.inStock
                    ? () => ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Cart arrives in Sprint 6')))
                    : null,

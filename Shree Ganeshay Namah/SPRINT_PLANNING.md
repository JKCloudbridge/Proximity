...
- Rider re-assignment / cancellation-triggered ledger reversal — both still depend on a cancellation flow that doesn't exist anywhere in this project yet (Sprint 7/8/9 have each flagged this and left it open).

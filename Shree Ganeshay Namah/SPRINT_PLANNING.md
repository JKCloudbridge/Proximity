...
- ~~Rider re-assignment / cancellation-triggered ledger reversal~~ — no longer an open, unscheduled gap as of Sprint 10: both now have a real, named line in Sprint 12's own §11 entry (see "Decided in Sprint 10," above), rather than being flagged open a fourth time.
